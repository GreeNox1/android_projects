package dev.greenox.data.local
...
object LocalEmailsDataProvider {
    ...
    val allEmails = listOf(
        Email(
            id = 0L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 9L),
        ...
        Email(
            id = 1L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 6L),
            recipients = listOf(LocalAccountsDataProvider.defaultAccount),
        ...
        Email(
            id = 2L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 5L),
            recipients = listOf(LocalAccountsDataProvider.defaultAccount),
        ...
        Email(
            id = 3L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 8L),
            recipients = listOf(LocalAccountsDataProvider.defaultAccount),
        ...
        Email(
            id = 4L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 11L),
        ...
        Email(
            id = 5L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 13L),
            recipients = listOf(LocalAccountsDataProvider.defaultAccount),
        ...
        Email(
            id = 6L,
            sender = LocalAccountsDataProvider.getContactAccountById(accountId = 10L),
            recipients = listOf(LocalAccountsDataProvider.defaultAccount),
