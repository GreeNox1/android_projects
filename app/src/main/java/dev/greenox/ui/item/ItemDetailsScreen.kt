...
import dev.greenox.InventoryTopAppBar
import dev.greenox.R
import dev.greenox.data.Item
import dev.greenox.ui.AppViewModelProvider
import dev.greenox.ui.navigation.NavigationDestination
import dev.greenox.ui.theme.InventoryTheme
    ...
    Scaffold(
        topBar = {
            ...
            FloatingActionButton(
                ...
                modifier = Modifier.padding(all = dimensionResource(id = R.dimen.padding_20))
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        var deleteConfirmationRequired by rememberSaveable { mutableStateOf(value = false) }
    ...
    Card(
        ...
        Column(
            ...
            verticalArrangement = Arrangement.spacedBy(
                space = dimensionResource(id = R.dimen.padding_16)
            )
        ) {
            ItemDetailsRow(
...
fun ItemDetailsScreenPreview() {
    InventoryTheme {
        ItemDetailsBody(
            ItemDetailsUiState(
                outOfStock = true,
                itemDetails = ItemDetails(id = 1, name = "Pen", price = "$100", quantity = "10")
            ),
            onSellItem = {},
            onDelete = {}
        )
